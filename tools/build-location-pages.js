...
${alternateMarkup(topic)}
    ...
    <link rel="stylesheet" href="/assets/css/georgian-landing.css" />
${rtlCss}    <title>${esc(copy.title)}</title>
  ...
  <body class="georgian-page georgian-content-page">
    <header class="subpage__header roomtypes__header georgian-hero georgian-subpage-hero">
      ...
      <nav class="georgian-breadcrumb" aria-label="${esc(labels.breadcrumb)}"><ol><li><a href="${meta.home}">${esc(labels.home)}</a></li><li aria-current="page">${esc(copy.h1)}</li></ol></nav>
