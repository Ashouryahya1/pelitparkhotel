...
const content = {
  airport: {
    ...
    tr: {
      title: "Trabzon Havalimanına Yakın Otel | Pelit Park Hotel", description: "Trabzon Havalimanına araçla yaklaşık 5 dakika: Pelit Park Hotel’de 24 saat resepsiyon, ücretsiz otopark ve farklı oda seçenekleri. Güncel fiyatları görün.",
      eyebrow: "Trabzon’a varış", h1: "Trabzon Havalimanına Yakın Otel", lead: "Pelit Park Hotel, Trabzon Havalimanına araçla yaklaşık 5 dakika uzaklıktadır; süre trafiğe göre değişir. Uçuş öncesi veya sonrası konaklamanız için 24 saat resepsiyon, ücretsiz otopark ve aile süiti dahil oda seçenekleri sunar.",
      introTitle: "Havalimanından otele ulaşım ve giriş saatleri", intro: "Havalimanından taksi veya kiralık araçla gelebilirsiniz. Otel kendi havalimanı transferini sağlamaz; resepsiyon dönüş yolculuğunuz için taksi çağırabilir. Giriş 14:00, çıkış 12:00’dedir. Oda hazırsa 09:00’dan itibaren ücretsiz erken giriş yapılabilir; oda hazır değilse bagajınızı resepsiyona bırakabilirsiniz.", imageAlt: "Pelit Park Hotel lobi ve resepsiyon alanı",
      cards: [["ri-route-line", "Yaklaşık 5 dakikalık yol", "Araçla tahmini süre trafiğe bağlıdır. Uçuşunuzdan önce havalimanı işlemleri için de zaman ayırın."], ["ri-time-line", "24 saat resepsiyon", "Geç uçuşlarda tahmini varış saatinizi WhatsApp üzerinden iletin. Konaklama tarihlerinizi gece varış saatinize göre seçin."], ["ri-parking-box-line", "Ücretsiz otopark", "Kiralık veya kendi aracınızla geldiğinizde otelin ücretsiz otoparkından yararlanabilirsiniz."]],
      sourceLabel: "DHMİ’nin güncel ulaşım bilgileri", faqTitle: "Havalimanı konaklaması hakkında", faqs: [["Otel havalimanına kaç dakika uzaklıkta?", "Araçla yaklaşık 5 dakika; trafik ve yol koşulları süreyi değiştirebilir."], ["Erken gelirsem ne yapabilirim?", "Normal giriş 14:00’tedir. Oda hazırsa 09:00’dan itibaren ücretsiz erken giriş mümkündür; aksi durumda bagajınızı resepsiyona bırakabilirsiniz."]],
    },
    en: {
      title: "Hotel Near Trabzon Airport | Pelit Park Hotel", description: "About 5 minutes from Trabzon Airport by car: Pelit Park Hotel offers 24-hour reception, free parking and family room options. Check rates for your dates.",
      eyebrow: "Arriving in Trabzon", h1: "Hotel Near Trabzon Airport", lead: "Pelit Park Hotel is approximately 5 minutes from Trabzon Airport by car, depending on traffic. Stay before or after your flight with a 24-hour reception, free on-site parking and room options including a family suite.",
      introTitle: "Getting to the hotel and checking in", intro: "Arrive from the airport by taxi or rental car. The hotel does not operate an airport transfer; reception can call a taxi for your departure. Check-in is at 14:00 and check-out at 12:00. Free early check-in from 09:00 is possible if your room is ready; otherwise, you can leave your luggage at reception.", imageAlt: "Lobby and reception area at Pelit Park Hotel in Trabzon",
      cards: [["ri-route-line", "About 5 minutes by car", "The estimated drive depends on traffic. Allow additional time for airport procedures before your flight."], ["ri-time-line", "24-hour reception", "Send your expected arrival time on WhatsApp for a late flight. Choose booking dates that cover your night of arrival."], ["ri-parking-box-line", "Free on-site parking", "Use the hotel’s complimentary parking when arriving in your own car or a rental vehicle."]],
      sourceLabel: "Current DHMİ transport information", faqTitle: "Airport-stay questions", faqs: [["How far is the hotel from Trabzon Airport?", "The drive takes approximately 5 minutes, depending on traffic and road conditions."], ["What if I arrive before check-in?", "Standard check-in is at 14:00. Free early check-in from 09:00 is possible if the room is ready; otherwise, you can leave your luggage at reception."]],
    },
    ar: {
      title: "فندق قريب من مطار طرابزون | Pelit Park Hotel", description: "بيليت بارك على بُعد نحو 5 دقائق بالسيارة من مطار طرابزون: استقبال 24 ساعة، مواقف مجانية وخيارات غرف عائلية. شاهد الأسعار حسب تواريخ رحلتك.",
      eyebrow: "الوصول إلى طرابزون", h1: "فندق قريب من مطار طرابزون", lead: "يبعد فندق بيليت بارك نحو 5 دقائق بالسيارة عن مطار طرابزون، حسب حركة المرور. يمكنك الإقامة قبل رحلتك أو بعدها مع استقبال على مدار الساعة، ومواقف مجانية وخيارات غرف تشمل جناحًا عائليًا.",
      introTitle: "الوصول من المطار وتسجيل الدخول", intro: "يمكنك الوصول من المطار بسيارة أجرة أو سيارة مستأجرة. لا يوفّر الفندق خدمة نقل خاصة من المطار؛ ويمكن للاستقبال طلب تاكسي عند مغادرتك. تسجيل الدخول الساعة 14:00 والخروج الساعة 12:00. يتاح الدخول المبكر مجانًا من الساعة 09:00 إذا كانت الغرفة جاهزة، وإلا يمكنك ترك الحقائب لدى الاستقبال.", imageAlt: "منطقة الاستقبال والردهة في Pelit Park Hotel بطرابزون",
      cards: [["ri-route-line", "نحو 5 دقائق بالسيارة", "مدة الطريق تقريبية وتتغير مع المرور. احسب أيضًا وقت إجراءات المطار قبل رحلتك."], ["ri-time-line", "استقبال على مدار الساعة", "أرسل وقت وصولك المتوقع على واتساب عند الوصول المتأخر، واختر تواريخ حجز تغطي ليلة وصولك."], ["ri-parking-box-line", "مواقف سيارات مجانية", "يمكنك استخدام مواقف الفندق المجانية سواء وصلت بسيارتك الخاصة أو سيارة مستأجرة."]],
      sourceLabel: "معلومات النقل الحالية من DHMİ", faqTitle: "أسئلة الإقامة المرتبطة بالمطار", faqs: [["كم يبعد الفندق عن مطار طرابزون؟", "نحو 5 دقائق بالسيارة، حسب حركة المرور وظروف الطريق."], ["ماذا أفعل إذا وصلت قبل موعد الدخول؟", "موعد الدخول المعتاد الساعة 14:00. إذا كانت الغرفة جاهزة، يتاح دخول مبكر مجاني من الساعة 09:00؛ وإلا يمكنك ترك الحقائب لدى الاستقبال."]],
    },
    ka: {
      title: "სასტუმრო ტრაბზონის აეროპორტთან ახლოს | Pelit Park Hotel", description: "Pelit Park Hotel ტრაბზონის აეროპორტიდან მანქანით დაახლოებით 5 წუთში: 24-საათიანი მიმღები, უფასო პარკინგი და ოჯახური ნომრები. ნახეთ თქვენი თარიღების ფასი.",
      eyebrow: "ტრაბზონში ჩამოსვლა", h1: "სასტუმრო ტრაბზონის აეროპორტთან ახლოს", lead: "Pelit Park Hotel ტრაბზონის აეროპორტიდან მანქანით დაახლოებით 5 წუთის სავალზეა; დრო მოძრაობაზეა დამოკიდებული. ფრენამდე ან ფრენის შემდეგ გელოდებათ 24-საათიანი მიმღები, უფასო პარკინგი და ოთახები, მათ შორის ოჯახური სუიტი.",
      introTitle: "აეროპორტიდან მოსვლა და სასტუმროში შესვლა", intro: "აეროპორტიდან შეგიძლიათ ტაქსით ან დაქირავებული მანქანით მოხვიდეთ. სასტუმროს საკუთარი ტრანსფერი არ აქვს; მიმღებს შეუძლია გამგზავრებისთვის ტაქსი გამოგიძახოთ. შესვლა 14:00-ზეა, გასვლა — 12:00-ზე. თუ ოთახი მზადაა, 09:00-დან ადრეული შესვლა უფასოა; სხვა შემთხვევაში ბარგი მიმღებთან შეგიძლიათ დატოვოთ.", imageAlt: "Pelit Park Hotel-ის ლობი და მიმღები ტრაბზონში",
      cards: [["ri-route-line", "მანქანით დაახლოებით 5 წუთი", "გზის დრო მოძრაობაზეა დამოკიდებული. ფრენამდე აეროპორტის პროცედურებისთვისაც გამოყავით დრო."], ["ri-time-line", "24-საათიანი მიმღები", "გვიანი ფრენისას მოსვლის სავარაუდო დრო WhatsApp-ზე მოგვწერეთ. ჯავშნის თარიღები ჩამოსვლის ღამეს უნდა მოიცავდეს."], ["ri-parking-box-line", "უფასო პარკინგი", "სასტუმროს უფასო პარკინგით შეგიძლიათ ისარგებლოთ როგორც საკუთარი, ისე დაქირავებული მანქანით."]],
      sourceLabel: "DHMİ-ის მიმდინარე სატრანსპორტო ინფორმაცია", faqTitle: "კითხვები აეროპორტთან განთავსებაზე", faqs: [["რა მანძილზეა სასტუმრო აეროპორტიდან?", "მანქანით დაახლოებით 5 წუთია; დრო მოძრაობასა და გზის პირობებზეა დამოკიდებული."], ["რა ხდება, თუ შესვლის დრომდე მოვალ?", "შესვლა 14:00-ზეა. თუ ოთახი მზადაა, 09:00-დან უფასო ადრეული შესვლა შესაძლებელია; სხვა შემთხვევაში ბარგი მიმღებთან დატოვეთ."]],
    },
  },
  forum: {
    ...
    en: {
      ...
      introTitle: "Walk to Forum Trabzon and plan your return", intro: "Forum Trabzon is approximately 2 minutes away by car, depending on traffic, or about a 15-minute walk from Pelit Park Hotel. The return walk is uphill; reception can call a taxi when you are carrying shopping bags. Check the shopping centre’s official website for current opening hours and stores.", imageAlt: "Clean and comfortable room at Pelit Park Hotel in Trabzon",
    ...
    ka: {
      ...
      introTitle: "Forum Trabzon-მდე მისვლა და სასტუმროში დაბრუნება", intro: "Pelit Park Hotel-დან Forum Trabzon-მდე მანქანით დაახლოებით 2 წუთია, მოძრაობის მიხედვით, ფეხით კი დაახლოებით 15 წუთი. უკან დასაბრუნებელი გზა აღმართზეა; შოპინგის შემდეგ მიმღებს შეუძლია ტაქსი გამოგიძახოთ. მაღაზიებისა და სამუშაო საათების მიმდინარე ინფორმაცია სავაჭრო ცენტრის ოფიციალურ გვერდზე გადაამოწმეთ.", imageAlt: "სუფთა და კომფორტული ოთახი Pelit Park Hotel-ში ტრაბზონში",
