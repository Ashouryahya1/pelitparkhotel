...
<html lang="${lang}" dir="${page.dir}"><head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/remixicon@4.0.0/fonts/remixicon.css" rel="stylesheet" /><link rel="stylesheet" href="/styles.css" /><link rel="stylesheet" href="/assets/css/georgian-landing.css?v=nav-cleanup-20260911" /><link rel="stylesheet" href="/assets/css/reviews.css?v=${REVIEW_STYLES_VERSION}" />${rtl}<title>${e(page.title)}</title>
