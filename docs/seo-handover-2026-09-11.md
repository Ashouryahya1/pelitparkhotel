...
| 14 | P1 | Google Hotels | Partially completed / provider-managed | The hotel owner confirmed that ElektraWeb/Rezervasyonal supplies hotel prices to Google and that the hotel website sends booking users to the provider's booking engine. | Obtain the connected Hotel Center account or Property ID, current feed status, Free Booking Links status and access details; add a provider callback or success event for completed-booking measurement. |
